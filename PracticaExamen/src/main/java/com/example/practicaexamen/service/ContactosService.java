...
public class ContactosService {
    ...
    public void addContacto(String nombre, String telefono, String parentesco) throws  IOException {
            validatePerson(nombre,telefono,parentesco);
    ...
    public void validatePerson(String nombre, String telefono, String parentesco){
